...
Otherwise, you can simply evaluate pre-trained models as explained in the `/src/test/test_models_visual.ipynb` notebook. Here, the idea is to load a model from a checkpoint and set it in evaluation mode and use helper functions to plot the predictions, losses and other metrics. 
