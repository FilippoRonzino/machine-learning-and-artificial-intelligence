...
if __name__ == "__main__":
    ...
    ecg_val_path = os.path.join(current_dir, 'data_storage', 'ecg_parquets', 'val_ecg.parquet')
    ...
    harmonic_val_path = os.path.join(current_dir, 'data_storage', 'harmonic_ou_parquets', 'val_harmonic.parquet')
    ...
    ou_val_path = os.path.join(current_dir, 'data_storage', 'harmonic_ou_parquets', 'val_ou.parquet')
    ...
    sp500_val_path = os.path.join(current_dir, 'data_storage', 'sp500_parquets', 'val_sp500.parquet')
    ...
    save_images_from_df_file(ecg_val_path, os.path.join(current_dir, 'images', 'ecg', 'val'), size=80)
    ...
    save_images_from_df_file(harmonic_val_path, os.path.join(current_dir, 'images', 'harmonic', 'val'), size=80)
    ...
    save_images_from_df_file(ou_val_path, os.path.join(current_dir, 'images', 'ou', 'val'), size=80)
    ...
    save_images_from_df_file(sp500_val_path, os.path.join(current_dir, 'images', 'sp500', 'val'), size=80)
